...
## Table of Content
   ...
   * [Docker container for PuTTY](#docker-container-for-putty)
...
|`DISABLE_RESTART_SESSION_DIALOG_WINDOW`| When set to `1`, the dialog window used to restart PuTTY session is not displayed. | `0` |
...
`putty.domain.tld` to the container at `127.0.0.1:5800`.
...
`server.domain.tld/putty` to the container at `127.0.0.1:5800`.
